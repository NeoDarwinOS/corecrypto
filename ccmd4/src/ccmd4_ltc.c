...
static void ccmd4_ltc_compress(ccdigest_state_t state, size_t nblocks, const void *in) {
...
static const uint32_t ccmd4_initial_state[4] = {
    0x67452301UL,
    0xefcdab89UL,
    0x98badcfeUL,
    0x10325476UL
